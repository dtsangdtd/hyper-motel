...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <groupId>com.in28minutes.springboot.rest.hyper</groupId>
...
```java
package com.in28minutes.springboot.rest.hyper;
...
### /src/main/java/com/in28minutes/springboot/rest/example/customer/Student.java

```java
package com.in28minutes.springboot.rest.hyper.exception;
...
### /src/main/java/com/in28minutes/springboot/rest/example/customer/StudentNotFoundException.java
...
### /src/main/java/com/in28minutes/springboot/rest/example/customer/StudentRepository.java

```java
package com.in28minutes.springboot.rest.hyper.exception;

import model.be.hyper.Student;
...
### /src/main/java/com/in28minutes/springboot/rest/example/customer/StudentResource.java
...
import com.in28minutes.springboot.rest.hyper.model.Customer;
import repository.be.hyper.StudentRepository;
...
public class StudentResource {
    ...
    public EntityModel<Student> retrieveStudent(@PathVariable long id) {
        Optional<Student> customer = studentRepository.findById(id);

        if (!customer.isPresent())
            throw new StudentNotFoundException("id-" + id);

        EntityModel<Student> resource = EntityModel.of(customer.get());
    ...
    public ResponseEntity<Object> createStudent(@RequestBody Student customer) {
        Student savedStudent = studentRepository.save(customer);
    ...
    public ResponseEntity<Object> updateStudent(@RequestBody Student customer, @PathVariable long id) {
...
```java
package com.in28minutes.springboot.rest.hyper.swagger;
